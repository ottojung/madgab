...
/// hid came" in the top 50. Beam priority is the generic prefix
/// objective (same four components/weights as the final score,
/// target-aligned cuts, symmetric Jaccard), so prefix retention and
/// terminal retention optimize one scalar.
#[test]
...
/// in the top 50. Same objective-aligned retention as above.
#[test]
